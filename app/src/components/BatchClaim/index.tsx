...
const Status = ({ connected }: StatusProps) => {
  ...
  useEffect(() => {
    ...
    const confetti = Confetti.connect(signer)
  ...
  }, [signer, accountList, accounts, Confetti])
    ...
    <BannerBox heading="Batch claim">
      <Box p="16px" textAlign="center">
        ...
        <Flex>
          ...
          >
            <Text ml="2" mb="2" fontSize="3xl" fontWeight="bold">
        ...
        <Flex justify="space-between">
          <Tooltip label="Total expected daily rewards">
            <Flex>
              ...
              <Text fontSize="2xl">~ {totalExpectedYield} /day</Text>
            </Flex>
          </Tooltip>
          <Tooltip
            label={
